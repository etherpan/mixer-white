...
const CHAIN_GRAPH_URLS = {
  ...
  56: 'https://api.thegraph.com/subgraphs/name/tornadocash/bsc-white-subgraph',
  100: 'https://api.thegraph.com/subgraphs/name/tornadocash/xdai-white-subgraph',
  137: 'https://api.thegraph.com/subgraphs/name/tornadocash/matic-white-subgraph',
  42161: 'https://api.thegraph.com/subgraphs/name/tornadocash/arbitrum-white-subgraph',
  43114: 'https://api.thegraph.com/subgraphs/name/tornadocash/avalanche-white-subgraph'
}
...
const registryClient = new ApolloClient({
  uri: 'https://api.thegraph.com/subgraphs/name/tornadocash/white-relayer-registry',
  cache: new InMemoryCache(),
  defaultOptions
})
